      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-600">Configure items and processings</p>
          </div>
          <div className="text-right">
            <p className="text-2xl font-bold text-green-600">${quote.finalTotal.toFixed(2)}</p>
            <p className="text-sm text-gray-600">{quote.items.length} items</p>
          </div>
        </div>
      </div>
