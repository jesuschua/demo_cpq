...
test.describe('Comprehensive Processing Options Test', () => {
  test('test processing options with complete app flow', async ({ page }) => {
    ...
    await page.screenshot({ path: 'comprehensive-1-current-state.png' });
    ...
    await page.screenshot({ path: 'comprehensive-2-final-state.png' });
    ...
    if (availableCount > 0) {
      ...
      if (cutToSizeCount > 0) {
        ...
        await cutToSizeButton.first().screenshot({ path: 'comprehensive-3-cut-to-size-button.png' });
        ...
        await page.screenshot({ path: 'comprehensive-4-after-click.png' });
        ...
        if (modalCount > 0) {
          ...
          await modal.screenshot({ path: 'comprehensive-5-option-modal.png' });
          ...
          if (inputCount > 0) {
            ...
            await page.screenshot({ path: 'comprehensive-6-input-filled.png' });
            ...
            await page.screenshot({ path: 'comprehensive-7-final-state.png' });
