...
test.describe('Find Configure Items Button', () => {
  test('find and click Configure Items button to get to quote builder', async ({ page }) => {
    console.log('🚀 Starting find configure items button test...');
    ...
    await page.screenshot({ path: 'find-configure-1-current-state.png' });
    
    // Step 11: Look for "Configure Items" button
    ...
    // Step 12: Take screenshot after navigation
    await page.screenshot({ path: 'find-configure-2-after-navigation.png' });
    ...
    if (availableCount > 0) {
      ...
      if (cutToSizeCount > 0) {
        ...
        await cutToSizeButton.first().screenshot({ path: 'find-configure-3-cut-to-size-button.png' });
        
        // Step 14: Click on "Cut to Size" and watch for debug logs
        ...
        await page.screenshot({ path: 'find-configure-4-after-click.png' });
        ...
        if (modalCount > 0) {
          ...
          await modal.screenshot({ path: 'find-configure-5-option-modal.png' });
          ...
          if (inputCount > 0) {
            ...
            await page.screenshot({ path: 'find-configure-6-input-filled.png' });
            ...
            await page.screenshot({ path: 'find-configure-7-final-state.png' });
