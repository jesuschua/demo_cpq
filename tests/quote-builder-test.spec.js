...
test.describe('Quote Builder Test', () => {
  test('test getting to quote builder and processing options', async ({ page }) => {
    console.log('🚀 Starting quote builder test...');
    ...
    await page.screenshot({ path: 'quote-builder-1-product-view.png' });
    
    // Step 9: Try to add a product
    ...
    if (productCount > 0) {
      ...
      await page.screenshot({ path: 'quote-builder-2-after-product-click.png' });
      ...
      if (!addButtonFound) {
        ...
        console.log(`🔍 Found ${buttonCount} buttons after clicking product`);
    ...
    // Step 10: Try to navigate to quote builder
    ...
    await page.screenshot({ path: 'quote-builder-3-after-continue.png' });
    
    // Step 12: Check if we can find the quote builder
    ...
    await page.screenshot({ path: 'quote-builder-4-final-state.png' });
    ...
    if (availableCount > 0) {
      ...
      if (cutToSizeCount > 0) {
        ...
        await cutToSizeButton.first().screenshot({ path: 'quote-builder-5-cut-to-size-button.png' });
        ...
        await page.screenshot({ path: 'quote-builder-6-after-click.png' });
        ...
        if (modalCount > 0) {
          ...
          await modal.screenshot({ path: 'quote-builder-7-option-modal.png' });
          ...
          if (inputCount > 0) {
            ...
            await page.screenshot({ path: 'quote-builder-8-input-filled.png' });
            ...
            await page.screenshot({ path: 'quote-builder-9-final-state.png' });
